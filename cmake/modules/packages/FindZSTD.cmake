...
#]=======================================================================]
MESSAGE("Specialized FindZSTD Called")
if( NOT $ENV{ZSTD_LIBRARY} STREQUAL "" )
  SET(ZSTD_LIBRARY $ENV{ZSTD_LIBRARY})
  Message("ZSTD_LIBRARY " ${ZSTD_LIBRARY})
  if(NOT $ENV{ZSTD_LIBRARY_RELEASE} STREQUAL "")
    set(ZSTD_LIBRARY_RELEASE, $ENV{ZSTD_LIBRARY_RELEASE})
  else ()
    set (ZSTD_LIBRARY_RELEASE, ${ZSTD_LIBRARY})
  endif()

  if(NOT $ENV{ZSTD_LIBRARY_DEBUG} STREQUAL "")
    set(ZSTD_LIBRARY_DEBUG, $ENV{ZSTD_LIBRARY_DEBUG})
  else ()
  ...
  mark_as_advanced(ZSTD_LIBRARY_RELEASE ZSTD_LIBRARY_DEBUG)

  if( NOT $ENV{ZSTD_INCLUDE_DIR} STREQUAL "" )
     SET(ZSTD_INCLUDE_DIR $ENV{ZSTD_INCLUDE_DIR})
  else()
     SET(ZSTD_INCLUDE_DIR "ZSTDIncludeDir")
  endif()
...
# Extract version information from the header file
  ...
  MESSAGE("FindZSTD ZSTD_VERSION " ${ZSTD_VERSION})
  ...
  if(NOT TARGET ${ZSTD_TARGET})
    ...
    MESSAGE("FindZSTD Setting ZSTD_TARGET " ${ZSTD_TARGET})
    ...
    if(EXISTS "${ZSTD_LIBRARY}")
      MESSAGE("FindZSTD Setting ZSTD_TARGET Libraries " ${ZSTD_LIBRARY})
      set_target_properties(${ZSTD_TARGET} PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES "CXX"
        IMPORTED_LOCATION "${ZSTD_LIBRARY}")
    else()
      MESSAGE("FindZSTD ZSTD_LIBARY " ${ZSTD_LIBRARY} " Does Not Exist")
    endif()

  endif()

  MESSAGE("FindZSTD Set By Envionment")
