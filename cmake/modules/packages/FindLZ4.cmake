...
### Find library ##############################################################
MESSAGE("Specialized FindLz4 Called")
if( NOT $ENV{LZ4_LIBRARY} STREQUAL "" )
  SET(LZ4_LIBRARY $ENV{LZ4_LIBRARY})
  if(NOT $ENV{LZ4_LIBRARY_RELEASE} STREQUAL "")
    set(LZ4_LIBRARY_RELEASE, $ENV{LZ4_LIBRARY_RELEASE})
  else ()
    set (LZ4_LIBRARY_RELEASE, ${LZ4_LIBRARY})
  endif()

  if(NOT $ENV{LZ4_LIBRARY_DEBUG} STREQUAL "")
    set(LZ4_LIBRARY_DEBUG, $ENV{LZ4_LIBRARY_DEBUG})
  else ()
  ...
  mark_as_advanced(LZ4_LIBRARY_RELEASE LZ4_LIBRARY_DEBUG)

  if( NOT $ENV{LZ4_INCLUDE_DIR} STREQUAL "" )
     SET(LZ4_INCLUDE_DIR $ENV{LZ4_INCLUDE_DIR})
  else()
     SET(LZ4_INCLUDE_DIR "Lz4IncludeDir")
  endif()
  ...
  MESSAGE("FindLZ4 Set By Envionment")
