...
MESSAGE("Specialized FindBLOSC Called")
if( NOT $ENV{BLOSC_LIBRARY} STREQUAL "" )
  SET(BLOSC_LIBRARY $ENV{BLOSC_LIBRARY})
  if(NOT $ENV{BLOSC_LIBRARY_RELEASE} STREQUAL "")
    set(BLOSC_LIBRARY_RELEASE, $ENV{BLOSC_LIBRARY_RELEASE})
  else ()
    set (BLOSC_LIBRARY_RELEASE, ${BLOSC_LIBRARY})
  endif()

  if(NOT $ENV{CRYPTOPP_LIBRARY_DEBUG} STREQUAL "")
    set(BLOSC_LIBRARY_DEBUG, $ENV{BLOSC_LIBRARY_DEBUG})
  else ()
    set (BLOSC_LIBRARY_DEBUG, ${BLOSC_LIBRARY})
  endif()

  SET(BLOSC_LIBRARIES ${BLOSC_LIBRARY})

  mark_as_advanced(BLOSC_LIBRARY_RELEASE BLOSC_LIBRARY_DEBUG)

  if( NOT $ENV{BLOSC_INCLUDE_DIR} STREQUAL "" )
     SET(BLOSC_INCLUDE_DIR $ENV{BLOSC_INCLUDE_DIR})
  else()
     SET(BLOSC_INCLUDE_DIR "BloscIncludeDir")
  endif()
  SET(BLOSC_INCLUDE_DIRS ${BLOSC_INCLUDE_DIR})
  mark_as_advanced(BLOSC_INCLUDE_DIR)
  ...
  if(BLOSC_FOUND AND NOT TARGET Blosc::Blosc)
     MESSAGE("FindBLOSC Setting BLOSC Target")
  ...
  MESSAGE("FindBLOSC Set By Envionment")
