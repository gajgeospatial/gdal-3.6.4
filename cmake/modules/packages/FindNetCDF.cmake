...
# NETCDF_HAS_MEM
#
MESSAGE("Specialized FindNetCDF Called")
if( NOT $ENV{NETCDF_LIBRARY} STREQUAL "" )
  SET(NETCDF_LIBRARY $ENV{NETCDF_LIBRARY})
  Message("NetCDF Library " ${NETCDF_LIBRARY})
  if(NOT $ENV{NETCDF_LIBRARY_RELEASE} STREQUAL "")
    set(NETCDF_LIBRARY_RELEASE, $ENV{NETCDF_LIBRARY_RELEASE})
  else ()
    set (NETCDF_LIBRARY_RELEASE, ${NETCDF_LIBRARY})
  endif()

  if(NOT $ENV{NETCDF_LIBRARY_DEBUG} STREQUAL "")
    set(NETCDF_LIBRARY_DEBUG, $ENV{NETCDF_LIBRARY_DEBUG})
  else ()
  ...
  mark_as_advanced(NETCDF_LIBRARY_RELEASE NETCDF_LIBRARY_DEBUG)

  if( NOT $ENV{NETCDF_INCLUDE_DIR} STREQUAL "" )
     SET(NETCDF_INCLUDE_DIR $ENV{NETCDF_INCLUDE_DIR})
  else()
     SET(NETCDF_INCLUDE_DIR "NetCDFIncludeDir")
  endif()
  SET(NETCDF_INCLUDE_DIRS ${NETCDF_INCLUDE_DIR})
  mark_as_advanced(NETCDF_INCLUDE_DIRS)
  Message("NetCDF Include Dir " ${NETCDF_INCLUDE_DIR} )

  SET(NETCDF_HAS_NC2 TRUE)
  SET(NETCDF_HAS_NC4 TRUE)
  SET(NETCDF_HAS_HDF4 TRUE)
  SET(NETCDF_HAS_HDF5 TRUE)
  SET(NETCDF_HAS_DAP TRUE)
  SET(NETCDF_HAS_MEM TRUE)

  SET(NETCDF_FOUND TRUE)
  if(NETCDF_FOUND)
    if(NOT TARGET NETCDF::netCDF)
        Message("Setting NetCDF Target")
  ...
  Message("NetCDF set from envionment")
else()
