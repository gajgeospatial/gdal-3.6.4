...
if( NOT $ENV{POSTGRESQL_LIBRARY} STREQUAL "" )
  ...
  if(NOT $ENV{POSTGRESQL_LIBRARY_RELEASE} STREQUAL "")
    set(PostgreSQL_LIBRARY_RELEASE, $ENV{POSTGRESQL_LIBRARY_RELEASE})
  else ()
    set (PostgreSQL_LIBRARY_RELEASE, ${PostgreSQL_LIBRARY})
  endif()

  if(NOT $ENV{POSTGRESQL_LIBRARY_DEBUG} STREQUAL "")
    set(PostgreSQL_LIBRARY_DEBUG, $ENV{POSTGRESQL_LIBRARY_DEBUG})
  else ()
    set (PostgreSQL_LIBRARY_DEBUG, ${PostgreSQL_LIBRARY})
  endif()

  SET(PostgreSQL_LIBRARIES ${PostgreSQL_LIBRARY})
  Message("PostgreSQL_LIBRARIES is set to " ${PostgreSQL_LIBRARIES})
  mark_as_advanced(PostgreSQL_LIBRARY_RELEASE PostgreSQL_LIBRARY_DEBUG)

  if( NOT $ENV{PostgreSQL_INCLUDE_DIR} STREQUAL "" )
     SET(PostgreSQL_TYPE_INCLUDE_DIR $ENV{POSTGRESQL_INCLUDE_DIR})
  else()
     SET(PostgreSQL_TYPE_INCLUDE_DIR "PostgreSQLTypeIncludeDir")
  endif()

  if( NOT $ENV{PostgreSQL_PQ_INCLUDE_DIR} STREQUAL "" )
     SET(PostgreSQL_INCLUDE_DIR $ENV{POSTGRESQL_PQ_INCLUDE_DIR})
  else()
     SET(PostgreSQL_INCLUDE_DIR "PostgreSQLIncludeDir")
  endif()

  SET(PostgreSQL_INCLUDE_DIRS ${PostgreSQL_TYPE_INCLUDE_DIR} ${PostgreSQL_INCLUDE_DIR})
