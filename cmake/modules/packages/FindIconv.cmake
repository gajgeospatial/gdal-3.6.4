...
#]=======================================================================]
MESSAGE("Specialized FindIconv Called")
if( NOT $ENV{ICONV_LIBRARY} STREQUAL "" )
  SET(Iconv_LIBRARY $ENV{ICONV_LIBRARY})
  if(NOT $ENV{ICONV_LIBRARY_RELEASE} STREQUAL "")
    set(Iconv_LIBRARY_RELEASE, $ENV{ICONV_LIBRARY_RELEASE})
  else ()
    set (Iconv_LIBRARY_RELEASE, ${ICONV_LIBRARY})
  endif()

  if(NOT $ENV{ICONV_LIBRARY_DEBUG} STREQUAL "")
    set(Iconv_LIBRARY_DEBUG, $ENV{ICONV_LIBRARY_DEBUG})
  else ()
    set (Iconv_LIBRARY_DEBUG, ${ICONV_LIBRARY})
  endif()

  SET(Iconv_LIBRARIES ${Iconv_LIBRARY})

  mark_as_advanced(Iconv_LIBRARY_RELEASE Iconv_LIBRARY_DEBUG)

  if( NOT $ENV{ICONV_INCLUDE_DIR} STREQUAL "" )
     SET(Iconv_INCLUDE_DIR $ENV{ICONV_INCLUDE_DIR})
  else()
     SET(Iconv_INCLUDE_DIR "IconvIncludeDir")
  endif()
  ...
  MESSAGE("FindIconv Set By Envionment")
