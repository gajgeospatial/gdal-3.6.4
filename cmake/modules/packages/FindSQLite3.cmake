...
MESSAGE("Specialized FindSQLITE3 Called")
if( NOT $ENV{SQLITE3_LIBRARY} STREQUAL "" )
  SET(SQLite3_LIBRARY $ENV{SQLITE3_LIBRARY})
  if(NOT $ENV{SQLITE3_LIBRARY_RELEASE} STREQUAL "")
    set(SQLite3_LIBRARY_RELEASE, $ENV{SQLITE3_LIBRARY_RELEASE})
  else ()
    set (SQLite3_LIBRARY_RELEASE, ${SQLite3_LIBRARY})
  endif()

  if(NOT $ENV{SQLITE3_LIBRARY_DEBUG} STREQUAL "")
    set(SQLite3_LIBRARY_DEBUG, $ENV{SQLITE3_LIBRARY_DEBUG})
  else ()
    set (SQLite3_LIBRARY_DEBUG, ${SQLite3_LIBRARY})
  endif()
  ...
  if( NOT $ENV{SQLITE3_INCLUDE_DIR} STREQUAL "" )
     SET(SQLite3_INCLUDE_DIR $ENV{SQLITE3_INCLUDE_DIR})
  else()
     SET(SQLite3_INCLUDE_DIR "SQLiteIncludeDir")
  endif()
...
# Extract version information from the header file
  ...
  if(SQLite3_INCLUDE_DIR AND SQLite3_LIBRARY)
    ...
    mark_as_advanced(SQLite3_HAS_COLUMN_METADATA SQLite3_HAS_RTREE SQLite3_HAS_LOAD_EXTENSION)
  endif()
  ...
  MESSAGE("FindSQLITE3 Set By Envionment")
