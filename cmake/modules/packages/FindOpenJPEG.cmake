...
MESSAGE("Specialized FindOpenJPEG Called")
if( NOT $ENV{OPENJPEG_LIBRARY} STREQUAL "" )
  SET(OPENJPEG_LIBRARY $ENV{OPENJPEG_LIBRARY})
  if(NOT $ENV{OPENJPEG_LIBRARY_RELEASE} STREQUAL "")
    set(OPENJPEG_LIBRARY_RELEASE, $ENV{OPENJPEG_LIBRARY_RELEASE})
  else ()
    set (OPENJPEG_LIBRARY_RELEASE, ${OPENJPEG_LIBRARY})
  endif()

  if(NOT $ENV{OPENJPEG_LIBRARY_DEBUG} STREQUAL "")
    set(OPENJPEG_LIBRARY_DEBUG, $ENV{OPENJPEG_LIBRARY_DEBUG})
  else ()
  ...
  mark_as_advanced(OPENJPEG_LIBRARY_RELEASE OPENJPEG_LIBRARY_DEBUG)

  if( NOT $ENV{OPENJPEG_INCLUDE_DIR} STREQUAL "" )
     SET(OPENJPEG_INCLUDE_DIR $ENV{OPENJPEG_INCLUDE_DIR})
  else()
     SET(OPENJPEG_INCLUDE_DIR "OpenJPEGIncludeDir")
  endif()
  ...
  if( NOT $ENV{OPENJPEG_JP2_INCLUDE_DIR} STREQUAL "" )
     SET(OPENJPEG_JP2_INCLUDE_DIR $ENV{OPENJPEG_JP2_INCLUDE_DIR})
  else()
     SET(OPENJPEG_JP2_INCLUDE_DIR "OpenJPEGJp2IncludeDir")
  endif()
  SET(OPENJPEG_INCLUDE_DIRS ${OPENJPEG_JP2_INCLUDE_DIR} ${OPENJPEG_INCLUDE_DIR})
  mark_as_advanced(OPENJPEG_INCLUDE_DIR)

  Message("FindOpenJpeg found version " ${OPENJPEG_VERSION_STRING})
  ...
  MESSAGE("FindOPENJPEG Set By Envionment")
