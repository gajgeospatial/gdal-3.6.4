...
#]=======================================================================]
MESSAGE("Specialized FindDeflate Called")
if( NOT $ENV{DEFLATE_LIBRARY} STREQUAL "" )
  SET(DEFLATE_LIBRARY $ENV{DEFLATE_LIBRARY})
  if(NOT $ENV{DEFLATE_LIBRARY_RELEASE} STREQUAL "")
    set(DEFLATE_LIBRARY_RELEASE, $ENV{DEFLATE_LIBRARY_RELEASE})
  else ()
    set (DEFLATE_LIBRARY_RELEASE, ${DEFLATE_LIBRARY})
  endif()

  if(NOT $ENV{DEFLATE_LIBRARY_DEBUG} STREQUAL "")
    set(DEFLATE_LIBRARY_DEBUG, $ENV{DEFLATE_LIBRARY_DEBUG})
  else ()
    set (DEFLATE_LIBRARY_DEBUG, ${DEFLATE_LIBRARY})
  endif()

  SET(DEFLATE_LIBRARIES ${DEFLATE_LIBRARY})

  mark_as_advanced(DEFLATE_LIBRARY_RELEASE DEFLATE_LIBRARY_DEBUG)

  if( NOT $ENV{DEFLATE_INCLUDE_DIR} STREQUAL "" )
     SET(DEFLATE_INCLUDE_DIR $ENV{DEFLATE_INCLUDE_DIR})
  else()
     SET(DEFLATE_INCLUDE_DIR "DeflateIncludeDir")
  endif()
  ...
  MESSAGE("FindDeflate Set By Envionment")
