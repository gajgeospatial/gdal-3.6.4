...
#]=======================================================================]
MESSAGE("Specialized FindProj Called")
if( NOT $ENV{PROJ_LIBRARY} STREQUAL "" )
  SET(PROJ_LIBRARY $ENV{PROJ_LIBRARY})
  if(NOT $ENV{PROJ_LIBRARY_RELEASE} STREQUAL "")
    set(PROJ_LIBRARY_RELEASE, $ENV{PROJ_LIBRARY_RELEASE})
  else ()
    set (PROJ_LIBRARY_RELEASE, ${PROJ_LIBRARY})
  endif()

  if(NOT $ENV{PROJ_LIBRARY_DEBUG} STREQUAL "")
    set(PROJ_LIBRARY_DEBUG, $ENV{PROJ_LIBRARY_DEBUG})
  else ()
  ...
  if( NOT $ENV{PROJ_INCLUDE_DIR} STREQUAL "" )
     SET(PROJ_INCLUDE_DIR $ENV{PROJ_INCLUDE_DIR})
  else()
     SET(PROJ_INCLUDE_DIR "ProjIncludeDir")
  endif()
  ...
  MESSAGE("FindProj Set By Envionment")
