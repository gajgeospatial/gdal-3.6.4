...
MESSAGE("Specialized FindGIF Called")
if( NOT $ENV{GIF_LIBRARY} STREQUAL "" )
  SET(GIF_LIBRARY $ENV{GIF_LIBRARY})
  if(NOT $ENV{GIF_LIBRARY_RELEASE} STREQUAL "")
    set(GIF_LIBRARY_RELEASE, $ENV{GIF_LIBRARY_RELEASE})
  else ()
    set (GIF_LIBRARY_RELEASE, ${GIF_LIBRARY})
  endif()
  Message("Gif Library is " ${GIF_LIBRARY})
  if(NOT $ENV{GIF_LIBRARY_DEBUG} STREQUAL "")
    set(GIF_LIBRARY_DEBUG, $ENV{GIF_LIBRARY_DEBUG})
  else ()
    set (GIF_LIBRARY_DEBUG, ${GIF_LIBRARY})
  endif()

  SET(GIF_LIBRARIES ${GIF_LIBRARY})

  mark_as_advanced(GIF_LIBRARY_RELEASE GIF_LIBRARY_DEBUG)

  if( NOT $ENV{GIF_INCLUDE_DIR} STREQUAL "" )
     SET(GIF_INCLUDE_DIR $ENV{GIF_INCLUDE_DIR})
  else()
     SET(GIF_INCLUDE_DIR "GIFIncludeDir")
  endif()
  ...
  message("GIF Version is " ${GIF_VERSION})
  SET(GIF_FOUND TRUE)

  if(GIF_FOUND)
    if(NOT TARGET GIF::GIF)
        MESSAGE("FindGIF Setting Gif Target")
  ...
  MESSAGE("FindGIF Set By Envionment")
