...
################################################################################
MESSAGE("Specialized FindECW Called")

if(NOT ECW_ROOT AND DEFINED ENV{ECW_ROOT})
  set(ECW_ROOT "$ENV{ECW_ROOT}")
endif()

if(NOT ECW_ROOT AND DEFINED ENV{ECW_DIR})
  set(ECW_ROOT "$ENV{ECW_DIR}")
  MESSAGE("Setting ECW_Root to " ${ECW_ROOT})
  set (ECW_INCLUDE_DIR ${ECW_ROOT}\\Include)
...
if (ECW_VERSION_STRING VERSION_GREATER_EQUAL 5.4)
